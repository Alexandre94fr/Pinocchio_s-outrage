...
struct Z_CompiledInDeferFile_FID_Mes_jeux_Unreal__GitHub_Pinocchio_s_outrage_GameFiles_Pinocchio_sOutrage_Source_Pinocchio_sOutrage_Public_Capacity_Capacities_NoseLengtheningCapacity_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ANoseLengtheningCapacity, ANoseLengtheningCapacity::StaticClass, TEXT("ANoseLengtheningCapacity"), &Z_Registration_Info_UClass_ANoseLengtheningCapacity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANoseLengtheningCapacity), 848440512U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Mes_jeux_Unreal__GitHub_Pinocchio_s_outrage_GameFiles_Pinocchio_sOutrage_Source_Pinocchio_sOutrage_Public_Capacity_Capacities_NoseLengtheningCapacity_h_1840909941(TEXT("/Script/Pinocchio_sOutrage"),
