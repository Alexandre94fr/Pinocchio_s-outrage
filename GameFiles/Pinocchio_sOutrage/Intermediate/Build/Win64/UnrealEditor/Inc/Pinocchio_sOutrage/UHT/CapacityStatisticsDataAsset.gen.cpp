...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UCapacityStatisticsDataAsset_Statics::NewProp_CapacityType = { "CapacityType", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCapacityStatisticsDataAsset, CapacityType), Z_Construct_UEnum_Pinocchio_sOutrage_EPlayerActionType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CapacityType_MetaData), NewProp_CapacityType_MetaData) }; // 3536600841
...
struct Z_CompiledInDeferFile_FID_Mes_jeux_Unreal__GitHub_Pinocchio_s_outrage_GameFiles_Pinocchio_sOutrage_Source_Pinocchio_sOutrage_Public_Statistics_CapacityStatisticsDataAsset_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCapacityStatisticsDataAsset, UCapacityStatisticsDataAsset::StaticClass, TEXT("UCapacityStatisticsDataAsset"), &Z_Registration_Info_UClass_UCapacityStatisticsDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCapacityStatisticsDataAsset), 1897183476U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Mes_jeux_Unreal__GitHub_Pinocchio_s_outrage_GameFiles_Pinocchio_sOutrage_Source_Pinocchio_sOutrage_Public_Statistics_CapacityStatisticsDataAsset_h_2710880849(TEXT("/Script/Pinocchio_sOutrage"),
